...
1. We created a sample Java app connected to your "Items" collection. Download and extract the app from the Azure Cosmos DB portal. 

2. From a command prompt or shell, run the following command to compile and resolve dependencies.
...
3. From a command prompt or shell, run the following command to run the application.
